...
describe('posts API', () => {
  ...
  describe('admin@casl.io', () => {
    ...
    includeExamplesFor(managingOwnArticles);
  ...
  describe('writer@casl.io', () => {
    ...
    includeExamplesFor(managingOwnArticles);
    includeExamplesFor(accessingSomebodyElseArticles);
  })
  ...
  function accessingSomebodyElseArticles() {
